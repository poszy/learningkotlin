...
/* The call to the work() method was delegated to the implementation of the Worker interface.
The call to takeVacation() wasn’t delegated;
it was executed on the Manager instance.
The call to doChores() method was delegated to the implementation of the Assistant interface.
Finally, the call to fileTimeSheet() method was executed on the Manager instance.
 Thus, the Manager instance has intercepted the call to fileTimeSheet(), avoiding any conflict or ambiguity to a call on Worker or on an Assistant*/